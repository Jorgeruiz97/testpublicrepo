...
class _MajorsOverview extends State<MajorsOverview> {
  var small_major_card_copy_3 = LayoutBuilder(builder: (context, constraints) {
    return SmallMajorCardLoved(
      constraints,
    );
  });
  var small_major_card_copy_2 = LayoutBuilder(builder: (context, constraints) {
    return SmallMajorCardLoved(
      constraints,
    );
  });
  var small_major_card_copy = LayoutBuilder(builder: (context, constraints) {
    return SmallMajorCardLoved(
      constraints,
    );
  });
  var small_major_card = LayoutBuilder(builder: (context, constraints) {
    return SmallMajorCardLoved(
      constraints,
    );
  });
  var small_major_card_copy_3_2 =
      LayoutBuilder(builder: (context, constraints) {
    return SmallMajorCardLoved(
      constraints,
    );
  });
  var small_major_card_copy_2_2 =
      LayoutBuilder(builder: (context, constraints) {
    return SmallMajorCardDefault(
      constraints,
    );
  });
  var small_major_card_2 = LayoutBuilder(builder: (context, constraints) {
    return SmallMajorCardDefault(
      constraints,
    );
  });
  var small_major_card_3 = LayoutBuilder(builder: (context, constraints) {
    return SmallMajorCardLoved(
      constraints,
    );
  });
