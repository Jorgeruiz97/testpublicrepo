                                                                          ...
                                                                          child:
                                                                              ...
                                                                              child: ChangeNotifierProvider(
                                                                                ...
                                                                                child: LayoutBuilder(
                                                                                  builder: (context, constraints) {
                                                                                    var widget = Person5(constraints);

                                                                                    context.read<Person>().setCurrentWidget(widget); // Setting active state

                                                                                    return GestureDetector(
                                                                                      onTap: () => context.read<Person>(), // TODO: add your method to change the state here
                                                                                      child: context.watch<Person>().currentWidget,
                                                                                    );
                                                                                  },
                                                                                ),
                                                                              ),
                                                                            ...
                                                                            Positioned(
                                                                              ...
                                                                              child: ChangeNotifierProvider(
                                                                                ...
                                                                                child: LayoutBuilder(
                                                                                  builder: (context, constraints) {
                                                                                    var widget = Person1(constraints);
                                                                            ...
                                                                            Positioned(
                                                                              ...
                                                                              child: ChangeNotifierProvider(
                                                                                ...
                                                                                child: LayoutBuilder(
                                                                                  builder: (context, constraints) {
                                                                                    var widget = Person12(constraints);
                                                                                  ...
                                                                                  child: Align(
                                                                                    ...
                                                                                    child: Stack(children: [
                                                                                      ChangeNotifierProvider(
                                                                                        ...
                                                                                        child: LayoutBuilder(
                                                                                          builder: (context, constraints) {
                                                                                            var widget = Person4(constraints);
                                                                                      ...
                                                                                      ChangeNotifierProvider(
                                                                                        ...
                                                                                        child: LayoutBuilder(
                                                                                          builder: (context, constraints) {
                                                                                            var widget = PersonFrame(constraints);
                                                                                  ...
                                                                                  child: Align(
                                                                                    ...
                                                                                    child: Stack(children: [
                                                                                      ChangeNotifierProvider(
                                                                                        ...
                                                                                        child: LayoutBuilder(
                                                                                          builder: (context, constraints) {
                                                                                            var widget = Person6(constraints);
                                                                                  ...
                                                                                  child: Align(
                                                                                    ...
                                                                                    child: Stack(children: [
                                                                                      ChangeNotifierProvider(
                                                                                        ...
                                                                                        child: LayoutBuilder(
                                                                                          builder: (context, constraints) {
                                                                                            var widget = Person8(constraints);
